...
```json
{
  ...
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=zahooruk2022&repo=java-rest-service",
  "buildTool" : "maven",
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=zahooruk2022&repo=java-rest-service'
